...
FruitStand.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
  const speechText = 'Welcome to the Fruit Stand. You can ask a question like, how do I store cucumbers? ... Now, what can I help you with.'
