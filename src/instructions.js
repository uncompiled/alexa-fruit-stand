...
const instructions = {
  // Refrigerated items
  apples:
    "apples can be stored at room temperature for one week, but should be refrigerated to keep longer",
  ...
  "green beans":
    "green beans should be refrigerated in a plastic bag. do not wash until ready to use",
  turnips:
    "raw turnips should be refrigerated in a plastic bag until ready to use",
  watercress:
    "for best results, wrap a wet cloth around its roots and place the watercress in a plastic bag before storing it in the refrigerator. watercress does not freeze well.",
  arugula:
    "arugula should be refrigerated inside a sealed plastic bag with a dry paper towel to absorb excess moisture. arugula does not freeze well.",
  "bok choy":
    "bok choy should be refrigerated in a plastic bag. do not wash until ready to use",
  "swiss chard":
    "swiss chard should be refrigerated in a plastic bag. do not wash until ready to use",
  "collard greens":
    "collard greens should be refrigerated in a plastic bag. do not wash until ready to use",
  zucchinis:
    "zucchinis should be refrigerated in a plastic bag.  do not wash until ready to use.",
  "dragon fruit":
    "dragon fruit will keep on the counter for a few days. if you want to keep it longer than that, store it in a plastic bag in the refrigerator",
  cilantro:
    "cilantro should be refrigerated. for best results, place stems in a jar of water with a plastic sandwich bag loosely covering the leaves",
  parsley:
    "parsley can be stored at room temperature or refrigerated. for best results, place stems in a jar of water with a plastic sandwich bag loosely covering the leaves",
  okra: "okrah should be refrigerated in a plastic bag. do not wash until ready to use",
  cranberries:
    "fresh cranberries can be stored in the refrigerator in a plastic bag or covered container for 3 to 4 weeks. alternatively, they can be frozen for up to 1 year",
  parsnips:
    "parsnips should be wrapped in a paper towel and placed in a plastic bag in the vegetable drawer of your refrigerator. they should last up to 2 weeks",

  // Ripen, then refrigerate
  avocados: "avocados should be ripened at room temperature, then refrigerated",
  cantaloupes:
    "cantaloupe should be stored at room temperature until ripe, then refrigerated. To freeze, cut the melon and place in airtight container or heavy-duty freezer bags.",
  kiwifruit:
    "kiwifruit should be ripened at room temperature, then refrigerated",
  kiwis: "kiwi should be ripened at room temperature, then refrigerated",
  nectarines:
    "nectarines should be ripened at room temperature, then refrigerated",
  ...
  starfruit:
    "starfruit, also known as carambola, should be ripened at room temperature, then refrigerated",
  ...
  clementines:
    "clementines can be stored for a few days at room temperature, but will last 1 to 2 weeks refrigerated",
  tangerines:
    "tangerines can be stored for a few days at room temperature, but will last 1 to 2 weeks refrigerated",
  oranges:
    "oranges can be stored for a few days at room temperature, but will last 1 to 2 weeks refrigerated",
  ...
  basil:
    "basil should be stored at room temperature. for best results, store in water",
  cucumbers:
    "cucumbers should be stored at room temperature. cucumbers can be kept in the refrigerator if consumed within 1 to 3 days",
  eggplants:
    "eggplant should be stored at room temperature. eggplant can be kept in the refrigerator if consumed within 1 to 3 days",
  peppers:
    "peppers should be stored at room temperature. peppers can be kept in the refrigerator if consumed within 1 to 3 days",
  ...
  potatoes:
    "potatoes should be stored in a well ventilated area in the pantry.  protect potatoes from light to avoid greening.",
  "sweet potatoes":
    "sweet potatoes should be stored in a well ventilated area in the pantry",
  ...
  raisins:
    "raisins should be stored in a cool dry area. after opening, place in sealed airtight container. in hot humid environments, refrigerate to extend shelf life",
  shallots:
    "shallots will keep for about a month stored at room temperature in a cool dry area. you can store them in the refrigerator, but they will only last for 2 weeks",

  // Weird things
  squash:
    "there are two types of squashes: summer and winter squash, which refer to the time of year the squash was harvested. summer squashes like yellow squash and zucchini should be refrigerated, while winter squashes like butternut squash and pumpkins should be stored at room temperature until they are ready to be prepared",
  fruit: "please ask for a specific type of fruit",
  vegetables: "please ask for a specific type of vegetable",

  // Easter eggs
  butter:
    "butter is not a fruit, but it should be refrigerated in its original wrapper. The foil laminated paper helps prevent spoilage from exposure to light and air and also protects butter from picking up the flavour of other foods. Once opened, both salted and unsalted butter will keep in the fridge for three weeks",
  coffee:
    "coffee beans should be stored at room temperature away from light. do not freeze or refrigerate coffee beans. coffee beans are porous and can absorb the flavor of other items in the refrigerator",
...
module.exports = {
  ...
  find(itemName) {
    ...
    return itemName
      ? instructions[itemName] || instructions[pluralize(itemName)]
      : false;
  },
  items: instructions,
};
